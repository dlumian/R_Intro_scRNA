---
title: "Advanced_R_Functionality"
...
R contians several built-in datasets, which are useful for exploring R functionality. 

This notebook will use the iris dataset which contains 150 iris observations of three species.
Each row contains informaiton on Sepal.Length, Sepal.Width, Petal.Length, Petal.Width and Species.
...
We can explictly remove the item with the below code.
```{r}
